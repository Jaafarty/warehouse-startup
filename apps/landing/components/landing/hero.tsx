...
import { Container, Display, Eyebrow, PrimaryCTA } from "./ui";
...
export function Hero() {
    // Signed-in visitors get a "Dashboard" CTA; signed-out visitors get
    // "Start free". (Book a demo was dropped.)
                ...
                <Stagger className="max-w-xl">
                    ...
                    <StaggerItem>
                        <p className="mt-6 max-w-[52ch] text-lg leading-relaxed text-muted-foreground">
                            Ware-House tracks stock, processes sales and
                            returns, and shows real-time analytics — across
                            every location and team.
                        </p>
                    </StaggerItem>
                    <StaggerItem>
